...
const Footer: React.FC = () => {
  ...
  return (
    <footer 
     // ref={footerRef}
      //className={`footer ${isVisible ? 'animate-slide-up' : ''}`}
    >
      <div className="footer__container container">
        ...
        <div className="footer__content">
          ...
          <div className="footer__section footer__section--brand">
            <div className="footer__brand">
              <div className="footer__logo">
                <span className="footer__logo-icon">{'{DM}'}</span>
                <span className="footer__logo-text">{PERSONAL_INFO.name}</span>
              </div>
          ...
          <div className="footer__section footer__section--nav">
            ...
            <nav className="footer__nav" role="navigation" aria-label="Footer navigation">
      ...
      <div className="footer__decoration" aria-hidden="true">
        <div className="footer__decoration-gradient"></div>
      </div>
    </footer>
  );
};
