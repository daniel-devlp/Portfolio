  ...
  return (
    <header 
      ...
      className={`navbar ${isScrolled ? 'navbar--scrolled' : ''} ${
        scrollDirection === 'down' ? 'navbar--hidden' : ''
      ...
      <div className="navbar__container container">
        ...
        <div className="navbar__brand">
          <Link to="/" className="navbar__logo" aria-label="Go to homepage">
            <span className="navbar__logo-icon">{'{DM}'}</span>
            <span className="navbar__logo-text">{PERSONAL_INFO.name}</span>
          </Link>
        </div>
      ...
      >
        <nav className="navbar__mobile-nav" role="navigation">
          <ul className="navbar__mobile-list">
            {NAVIGATION_ITEMS.map((item, index) => (
              <li key={item.id} className="navbar__mobile-item">
                <Link
                  to={item.path}
